        ...
        <footer className="footer m-0 p-0">
            <div className="footer-body">
                <ul className="left-panel list-inline m-0 p-0">
                    <li className="list-inline-item"><Link to={permissionData?.id ? "/user/privacy-policy" : "/privacy-policy"}>গোপনীয়তা নীতিমালা</Link></li>
                    <li className="list-inline-item"><Link to={permissionData?.id ? "/user/terms-of-service" : "/terms-of-service"}>সেবার নির্দেশাবলী</Link></li>
                </ul>
