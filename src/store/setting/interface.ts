...
export interface SettingState {
    ...
    setting: {
        ...
        app_short_name: SettingValueMap,
        app_bn_name: SettingValueMap,
        app_short_bn_name: SettingValueMap,
        app_bn_address: SettingValueMap,
        app_phone: SettingValueMap,
        app_email: SettingValueMap,
        app_en_address: SettingValueMap,
...
export interface SettingDefaultState {
    ...
    setting: {
        ...
        app_short_name: DefaultVStringMap,
        app_bn_name: DefaultVStringMap,
        app_short_bn_name: DefaultVStringMap,
        app_bn_address: DefaultVStringMap,
        app_en_address: DefaultVStringMap,
        app_phone: DefaultVStringMap,
        app_email: DefaultVStringMap,
