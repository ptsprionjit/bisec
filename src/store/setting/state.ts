...
export const initialState: SettingState = {
  ...
  "setting": {
    ...
    "app_bn_name": {
      "value": "মাধ্যমিক ও উচ্চমাধ্যমিক ‍শিক্ষা বোর্ড, কুমিল্লা"
    },
    "app_short_bn_name": {
      "value": "বিআইএসই কুমিল্লা"
    },
    "app_bn_address": {
      "value": "লাকসাম রোড, কান্দিরপাড়, কুমিল্লা"
    },
    "app_en_address": {
      "value": "Laksam Road, Kandirpar, Cumilla"
    },
    "app_phone": {
      "value": "+880-233-440-6328"
    },
    "app_email": {
      "value": "chairman@comillaboard.gov.bd"
    },
...
export const defaultState: SettingDefaultState = {
  ...
  "setting": {
    ...
    app_short_name: {
      target: '[data-setting="app_short_name"]',
      choices: [],
      type: "text",
      value: "BISEC",
    },
    ...
    app_bn_address: {
      target: '[data-setting="app_bn_address"]',
      choices: [],
      type: "text",
      value: "লাকসাম রোড, কান্দিরপাড়, কুমিল্লা",
    },
    ...
    app_en_address: {
      target: '[data-setting="app_en_address"]',
      choices: [],
      type: "text",
      value: "Laksam Road, Kandirpar, Cumilla",
    },
