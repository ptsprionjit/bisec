...
export const app_short_name = (state): String => state.setting.setting.app_short_name.value;
export const app_bn_name = (state): String => state.setting.setting.app_bn_name.value;
export const app_short_bn_name = (state): String => state.setting.setting.app_short_bn_name.value;
