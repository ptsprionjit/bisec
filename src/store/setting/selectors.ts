...
export const app_phone = (state): String => state.setting.setting.app_phone.value;
export const app_email = (state): String => state.setting.setting.app_email.value;
export const app_short_bn_name = (state): String => state.setting.setting.app_short_bn_name.value;
export const app_bn_address = (state): String => state.setting.setting.app_bn_address.value;
export const app_en_address = (state): String => state.setting.setting.app_en_address.value;
