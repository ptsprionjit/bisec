         ...
         if (!isValid) {
            ...
            try {
               ...
               if (response.status === 200) {
                  ...
                  await setUserData({ ...userData, ...response.data.feeData });
                  setValidSearch(true);
                  setValidated(false);
               } else {
                     ...
                     <Card.Body>
                        <Row>
                           ...
                           <Col md={12} className='my-3'>
                              <h6 className="text-uppercase text-center text-success">এন্ট্রিকৃত আবেদন ফি</h6>
                              <h6 className="text-uppercase text-center text-warning">(কোন ফি প্রযোজ্য না হলে সেখানে ০ (শূণ্য) থাকতে হবে)</h6>
                           </Col>
