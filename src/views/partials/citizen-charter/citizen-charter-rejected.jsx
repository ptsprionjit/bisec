...
const CitizenCharterRejected = () => {
    ...
    const fetchDataList = async () => {
        ...
        try {
            const response = await axiosApi.post(`/citizen/charter/list/rejected`);
                ...
                <Col md={12} className='m-0 p-0'>
                    <Card className='m-0 p-3'>
                        <Card.Header className="d-flex flex-column justify-content-center align-items-center m-0 p-0">
                            <h4 className={"card-title text-center text-primary pb-2"}>সিটিজেন চার্টারের বাতিলকৃত সেবার তালিকাসমূহ</h4>
...
export default CitizenCharterRejected;