...
import CitizenCharterForm from './application/citizen-charter-app';
import CitizenCharterPrint from './print/citizen-charter-print';

import { useAuthProvider } from "../../../context/AuthContext.jsx";
import axiosApi from "../../../lib/axiosApi.jsx";

const CitizenCharterProcess = () => {
    ...
    const fetchDataList = async () => {
        ...
        try {
            const response = await axiosApi.post(`/citizen/charter/list/processing`);
    ...
    const applicationAuthorize = async (userData) => {
        ...
        if (!isValid) {
            ...
            try {
                const response = await axiosApi.post(`/citizen/charter/authorize`, { userData: userData });
                ...
                <Col md={12} className='m-0 p-0'>
                    <Card className='m-0 p-3'>
                        <Card.Header className="d-flex flex-column justify-content-center align-items-center m-0 p-0">
                            <h4 className={"card-title text-center text-primary pb-2"}>সিটিজেন চার্টারের অপেক্ষমান সেবার তালিকাসমূহ</h4>
                                                    ...
                                                    <tr key={idx}>
                                                        ...
                                                        <td className='text-center align-top text-wrap p-2 m-0'>
                                                            <div className='d-flex justify-content-center align-items-center flex-wrap gap-3'>
                                                                {permissionData.role === '16' && <>
                                                                    <Button className='m-0 p-1' type="button" onClick={() => handleAuthorizeClick(item)} variant="btn btn-success" data-toggle="tooltip" data-placement="top" title={permissionData.role === '16' ? "অনুমোদন" : "অনুমোদনের জন্য প্রেরণ"} data-original-title={permissionData.role === '16' ? "অনুমোদন" : "অনুমোদনের জন্য প্রেরণ"}>
                                                                    ...
                                                                    <Button className='m-0 p-1' type="button" onClick={() => handleSendBackClick(item)} variant="btn btn-warning" data-toggle="tooltip" data-placement="top" title="ফেরৎ প্রদান" data-original-title="ফেরৎ প্রদান">
                                                                        <span className="btn-inner">
                ...
                >
                    <Modal.Header closeButton>
                        <Modal.Title className={'text-center'}>
                            <h4 className={'text-center'}>সেবা অনুমোদন করতে চান?</h4>
...
export default CitizenCharterProcess;