...
const LeaveAppApprove = () => {
    ...
    const fetchDataList = async () => {
        ...
        try {
            const response = await axiosApi.post(`/leave/application/list`, { app_status: '15' });
                ...
                <Col md={12} className='m-0 p-0'>
                    <Card className='m-0 p-3'>
                        <Card.Header className="d-flex flex-column justify-content-center align-items-center m-0 p-0">
                            <h4 className={"card-title text-center text-primary pb-2"}>ছুটির অপেক্ষমান আবেদনসমূহ</h4>
...
export default LeaveAppApprove;