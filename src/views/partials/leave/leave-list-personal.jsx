...
const LeaveAppPersonal = () => {
    ...
    const fetchDataList = async () => {
        ...
        try {
            const response = await axiosApi.post(`/leave/application/list/personal`);
    ...
    const applicationReject = async (userData) => {
        userData.comment = `আবেদনকারী নিজে ছুটির আবেদনটি বাতিল করেছেন`;
        let isValid = true;
        const newErrors = {};
                ...
                <Col md={12} className='m-0 p-0'>
                    <Card className='m-0 p-3'>
                        <Card.Header className="d-flex flex-column justify-content-center align-items-center m-0 p-0">
                            <h4 className={"card-title text-center text-primary pb-2"}>ব্যক্তিগত ছুটির আবেদনসমূহ</h4>
                                        ...
                                        <tbody>
                                            {
                                                filteredData.map((item, idx) => (
                                                    <tr key={idx}>
                                                        ...
                                                        <td className='text-center align-top text-wrap'>
                                                            {item.id_status === "17" && <p className={"text-success text-center align-center text-wrap p-1 m-0"}>{item.bn_app_status}</p>}
                                                            {item.id_status === "18" && <p className={"text-danger text-center align-center text-wrap p-1 m-0"}>{item.bn_app_status}</p>}
                                                            {(item.id_status !== "17" && item.id_status !== "18") && <p className={"text-center align-center text-wrap p-1 m-0"}>{item.bn_app_status}</p>}
                                                        </td>
                                                        <td>
                                                            <div className="d-flex justify-content-center align-items-center flex-wrap gap-3">
                                                                ...
                                                                {item.id_status === "13" && <Button className='m-0 p-1' type="button" onClick={() => handleRejectClick(item)} variant="btn btn-danger" data-toggle="tooltip" data-placement="top" title="বাতিল" data-original-title="বাতিল">
                                                                    <span className="btn-inner">
...
export default LeaveAppPersonal;