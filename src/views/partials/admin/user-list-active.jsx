...
const ActiveUserList = () => {
   ...
   useEffect(() => {
      ...
      const fetchDataList = async () => {
         ...
         try {
            const response = await axios.post(`${BACKEND_URL}/user/list/active`, {});
            if (response.status === 200) {
               ...
               if (allUsers?.length) {
                  ...
                  setLoadingError("কোন সচল (ACTIVE) ব্যবহারকারী (কর্মকর্তা/কর্মচারী) পাওয়া যায়নি!");
               }
            } else {
               setLoadingError("কোন সচল (ACTIVE) ব্যবহারকারী (কর্মকর্তা/কর্মচারী) পাওয়া যায়নি!");
            }
               ...
               <Card>
                  <Card.Header className="d-flex justify-content-between">
                     <div className="header-title d-flex flex-column justify-content-center align-items-center w-100">
                        <h4 className={styles.SiyamRupaliFont + " card-title text-center text-primary flex-fill"}>বোর্ডের সচল (ACTIVE) ইউজার আইডিসমূহ</h4>
                     </div>
                  </Card.Header>
               ...
               <Card>
                  <Card.Header className="d-flex justify-content-between">
                     <div className="header-title w-100">
                        <h4 className="card-title text-center text-primary flex-fill"><span className={styles.SiyamRupaliFont + " text-center"}>বোর্ডের সচল (ACTIVE) ইউজার আইডিসমূহ</span></h4>
                     </div>
                  </Card.Header>
                  <Card.Body className="px-0">
