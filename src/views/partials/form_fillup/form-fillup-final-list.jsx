            ...
            <Col md={12}>
               <Card className='p-0 mb-2'>
                  <Card.Body className='py-1 m-0 d-flex flex-column justify-content-center align-items-center'>
                     <h4 className={styles.SiyamRupaliFont + " text-center text-uppercase card-title pt-2"}>নিবন্ধিত (চুড়ান্ত/Final) শিক্ষার্থীদের তালিকা</h4>
...
export default FormFillupFinalList;