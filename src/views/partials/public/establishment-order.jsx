...
const EstablishmentOrder = () => {
   ...
   const distancePopulationEval = () => {
      ...
      minValue.inst_distance = '৪';
      minValue.inst_population = '৭৫,০০০';

      switch (printData.inst_region) {
         case '01':
         case '02':
            switch (printData.inst_status) {
               case '11':
               case '12':
               case '17':
                  minValue.inst_distance = '১';
                  minValue.inst_population = '১০,০০০';
                  break;
               case '13':
               case '20':
                  minValue.inst_distance = '২';
                  minValue.inst_population = '৭৫,০০০';
                  break;
               case '19':
                  minValue.inst_distance = '২';
                  minValue.inst_population = '৬৫,০০০';
                  break;
               default:
                  break;
            }
   ...
   useEffect(() => {
      const fetchPrintData = async () => {
         ...
         if (!id_order) {
            ...
            try {
               const response = await axios.post(`${BACKEND_URL}/institute/establishment/print_order`, { id_order: id_order });
               if (response.status === 200) {
                  setPrintData(response.data.data);
                  await fetchProfileSign(response.data.data.id_signed);
                  distancePopulationEval();
            ...
            <Col ref={printRef} id="print-area" md="8" className='m-0 p-2'>
               <Card className="card-transparent shadow-none d-flex justify-content-center">
                  ...
                  <Card.Body className="p-3 m-0">
                     ...
                     <h6 style={{ textAlign: 'justify' }} className={styles.SiyamRupaliFont + " text-left text-uppercase py-2"}>বিষয়ঃ {printData.bn_dist} জেলার {printData.bn_uzps} উপজেলাধীন {printData.clst_status} পর্যায়ে {printData.inst_bn_name} নামীয় প্রতিষ্ঠান স্থাপনের প্রাথমিক অনুমতি প্রদান প্রসঙ্গে।</h6>
                     ...
                     <h6 style={{ textAlign: 'justify' }} className={styles.SiyamRupaliFont + styles.text_justify}>
                        <small>
                           ০১। {printData.clst_status} পর্যায়ে স্থাপনের অনুমতি কোনক্রমেই স্বীকৃতি/পাঠদানের অনুমতি হিসেবে গণ্য করা যাবে না। <br />
                           ...
                           ০৩। প্রতিষ্ঠানের চতুর্দিকে সমপর্যায়ের অন্য প্রতিষ্ঠানের দূরত্ব কমপক্ষে { instMinAmount.inst_distance} কিলোমিটার এবং প্রতিষ্ঠান এলাকায় জনস্যখ্যা কমপক্ষে { instMinAmount.inst_population } হতে হবে হবে। <br />
                           ...
                           ১৩। বেসরকারি প্রতিষ্ঠানের প্রচলিত নীতিমালার অন্যান্য শর্ত মেনে চলতে হবে এবং কোন শর্ত প্রতিপারনে ব্যর্থ হলে বোর্ড/সরকার যে কোন সময় এ অনুমোদন বাতিল করতে পারে।<br />
