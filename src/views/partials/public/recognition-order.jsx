...
const RecognitionOrder = () => {
   ...
   const classStartAppEval = () => {
      ...
      switch (printData.inst_region) {
         case '01':
            switch (printData.bn_recog_status) {
               case '11':
            ...
            <Col ref={printRef} id="print-area" md="8" className='m-0 p-2'>
               <Card className="card-transparent shadow-none d-flex justify-content-center">
                  ...
                  <Card.Body className="p-3 m-0">
                     ...
                     <h6 style={{ textAlign: 'justify' }} className={styles.SiyamRupaliFont + " text-left text-uppercase py-2"}>বিষয়ঃ {printData.bn_dist} জেলার {printData.bn_uzps} উপজেলাধীন {printData.inst_bn_name} এর {printData.bn_recog_status} পর্যায়ে স্বীকৃতি/স্বীকৃতি নবায়নের অনুমতি প্রদান প্রসঙ্গে।</h6>
                     ...
                     <h6 style={{ textAlign: 'justify' }} className={styles.SiyamRupaliFont + styles.text_justify + ' py-2'}>উপর্যুক্ত বিষয় ও সূত্রের প্রেক্ষিতে নির্দেশক্রমে জানানো যাচ্ছে যে, বর্ণিত প্রতিষ্ঠানটিকে নিচে উল্লেখিত শর্তে {printData.bn_recog_status} পর্যায়ে স্বীকৃতি/স্বীকৃতি নবায়নের অনুমতি প্রদান করা হলো। প্রতিষ্ঠানে জাতীয় শিক্ষাক্রম ও পাঠ্যপুস্তক বোর্ডের নির্ধারিত পাঠ্যসূচি ও কেবলমাত্র বোর্ড কর্তৃক অনুমতিপ্রাপ্ত বিষয়সমূহ পাঠদান করতে হবে এবং প্রদত্ত মেয়াদকালের মধ্যে স্বীকৃতি নবায়নের জন্য ফি জমাসহ আবেদন পেশ ও আরোপিত শর্তাদি পূরণের ব্যবস্থা করতে হবে।</h6>
                     ...
                     <h6 style={{ textAlign: 'justify' }} className={styles.SiyamRupaliFont + styles.text_justify}>
                        <small>
                           ০১। {printData.bn_recog_status} পর্যায়ে পাঠদানের অনুমতি কোনক্রমেই স্বীকৃতি হিসেবে গণ্য করা যাবে না। <br />
...
export default RecognitionOrder
