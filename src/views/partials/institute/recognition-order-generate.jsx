    ...
    const appOrderGen = async (app_data) => {
        ...
        requiredFields.forEach(field => {
            ...
            switch (field) {
                ...
                case 'effective_date':
                    dataError = ValidationInput.dateCheck(userData[field] || '1901-01-01', '2020-01-01', activeAppDetails.expiry_date);
                    break;

                case 'expiry_date':
                    dataError = ValidationInput.dateCheck(userData[field] || '1901-01-01', activeAppDetails.effective_date, '2099-12-31');
                    break;
        ...
        if (!isValid) {
            ...
            const email_message = `বেসরকারি শিক্ষা প্রতিষ্ঠান (নিম্ন মাধ্যমিক, মাধ্যমিক ও উচ্চ মাধ্যমিক) স্থাপন, পাঠদান ও একাডেমিক স্বীকৃতি প্রদান নীতিমালা- ২০২২ (সংশোধিত- ২০২৩) এর অনুচ্ছেদ ৬.০ অনুযায়ী আপনাকে নতুন প্রতিষ্ঠানের পাঠদানের আবেদনের প্রেক্ষিতে বোর্ডের মঞ্জুরি কমিটির ${ValidationInput.E2BDigit(formatDate(activeAppDetails.grant_assembly_date))} তারিখের ${activeAppDetails.grant_assembly} তম সভার সুপারিশ এবং ${ValidationInput.E2BDigit(formatDate(activeAppDetails.board_assembly_date))} তারিখে অনুষ্ঠিত ${activeAppDetails.board_assembly} তম বোর্ড সভার অনুমোদিত সিদ্ধান্ত মোতাবেক পাঠদানের প্রাথমিক (শর্তসহ) অনুমোদন প্রদান করা হলো। বিস্তরিত অনুমতিপত্রের জন্য সংযুক্ত লিঙ্কে ক্লিক করুন।`;
                    ...
                    <Card>
                        <Card.Header className="d-flex justify-content-between">
                            <div className="header-title d-flex flex-column justify-content-center align-items-center w-100">
                                <h4 className={styles.SiyamRupaliFont + " card-title text-center text-primary flex-fill"}>প্রতিষ্ঠানের স্বীকৃতি/স্বীকৃতি নবায়নের আদেশ তৈরি ও প্রেরণের অপেক্ষমান আবেদনসমূহ</h4>
                                                ...
                                                filteredData.map((item, idx) => (
                                                    <tr key={idx}>
                                                        ...
                                                        <td className='text-center align-top text-wrap'>
                                                            ...
                                                            {item.email_ref && <Button type="button" variant="btn btn-outline-secondary" onClick={() => window.open(`${FRONTEND_URL}/order-emails?id_email=${item.email_ref}&prev_location=/recognition/generate-order`, '_blank', 'noopener,noreferrer')}>তদন্তের আদেশ প্রিন্ট</Button>}
                                                        </td>
                                                        <td className='text-center align-top text-wrap'>
                                                            ...
                                                            <Button type="button" variant="btn btn-outline-primary" onClick={() => window.open(`${FRONTEND_URL}/payment/response/success?prev_location=/recognition/generate-order&invoiceNo=${item.id_invoice}`, '_blank', 'noopener,noreferrer')}>প্রিন্ট ভাউচার</Button>
                                                        </td>
                                                        {/* <td className='text-center align-top text-wrap'>
                                                            ...
                                                            <p className={styles.SiyamRupaliFont + " text-center text-dark align-center text-wrap p-1 m-0"}>{item.bn_status}</p>
                                                        </td> */}
                                                        <td className='text-center align-top text-wrap'>
                                ...
                                <Row>
                                    <Col className='my-2' md={6}>
                                        ...
                                        <Form.Control
                                            ...
                                            maxLength={120}
                                            id="grant_assembly"
                                            value={activeAppDetails.grant_assembly}
                                            isInvalid={validated && !!userDataError.grant_assembly}
                                            isValid={validated && activeAppDetails.grant_assembly && !userDataError.grant_assembly}
                                    ...
                                    <Col className='my-2' md={6}>
                                        ...
                                        <Form.Control
                                            ...
                                            value={activeAppDetails.grant_assembly_date}
                                            isInvalid={validated && !!userDataError.grant_assembly_date}
                                            isValid={validated && activeAppDetails.grant_assembly_date && !userDataError.grant_assembly_date}
                                    ...
                                    <Col className='my-2' md={6}>
                                        ...
                                        <Form.Control
                                            ...
                                            maxLength={120}
                                            id="board_assembly"
                                            value={activeAppDetails.board_assembly}
                                            isInvalid={validated && !!userDataError.board_assembly}
                                            isValid={validated && activeAppDetails.board_assembly && !userDataError.board_assembly}
                                    ...
                                    <Col className='my-2' md={6}>
                                        ...
                                        <Form.Control
                                            ...
                                            value={activeAppDetails.board_assembly_date}
                                            isInvalid={validated && !!userDataError.board_assembly_date}
                                            isValid={validated && activeAppDetails.board_assembly_date && !userDataError.board_assembly_date}
                                    ...
                                    <Col className='my-2' md={6}>
                                        ...
                                        <Form.Control
                                            ...
                                            type="date"
                                            id="effective_date"
                                            value={activeAppDetails.effective_date}
                                            isInvalid={validated && !!userDataError.effective_date}
                                            isValid={validated && activeAppDetails.effective_date && !userDataError.effective_date}
                                            onChange={(e) => {
                                    ...
                                    <Col className='my-2' md={6}>
                                        ...
                                        <Form.Control
                                            ...
                                            type="date"
                                            id="expiry_date"
                                            value={activeAppDetails.expiry_date}
                                            isInvalid={validated && !!userDataError.expiry_date}
                                            isValid={validated && activeAppDetails.expiry_date && !userDataError.expiry_date}
                    ...
                    <Card>
                        <Card.Header className="d-flex justify-content-between">
                            <div className="header-title w-100">
                                <h4 className="card-title text-center text-primary flex-fill"><span className={styles.SiyamRupaliFont + " text-center"}>প্রতিষ্ঠানের স্বীকৃতি/স্বীকৃতি নবায়নের আদেশ তৈরি ও প্রেরণের অপেক্ষমান আবেদনসমূহ</span></h4>
                            </div>
                        </Card.Header>
                        <Card.Body className="px-0">
...
export default InstRecognitionOrder;