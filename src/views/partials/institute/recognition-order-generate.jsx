                                                ...
                                                <table id="user-list-table" className="table table-bordered border-dark border-2 w-100 m-0 p-0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr className='print-hide'>
                                                            ...
                                                            <td colSpan={4} className='text-center align-top text-wrap p-2 m-0'>
                                                                {recognitionFiles.inquiry_details && String(recognitionFiles.inquiry_details.name).toLocaleLowerCase() === 'inquiry_details.pdf' && <Button onClick={() => handleFileView('inquiry_details')} type='button' variant='btn btn-link' className='w-100 m-0 p-0'><span className={styles.SiyamRupaliFont + " text-center text-primary"}>সর্বশেষ কমিটির স্মারক</span></Button>}
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                    <tfoot>
