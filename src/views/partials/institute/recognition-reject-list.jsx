...
const InstRecognitionReject = () => {
    ...
    const fetchDataList = async () => {
        ...
        try {
            const response = await axios.post(`${BACKEND_URL}/institute/recognition/list`, { app_status: '18' });
                        ...
                        <Card>
                            <Card.Header className="d-flex justify-content-between">
                                <div className="header-title d-flex flex-column justify-content-center align-items-center w-100">
                                    <h4 className={styles.SiyamRupaliFont + " card-title text-center text-primary flex-fill"}>প্রতিষ্ঠানের স্বীকৃতি/স্বীকৃতি নবায়নের বাতিলকৃত আবেদনসমূহ</h4>
                                </div>
                            </Card.Header>
                        ...
                        <Card>
                            <Card.Header className="d-flex justify-content-between">
                                <div className="header-title w-100">
                                    <h4 className="card-title text-center text-primary flex-fill"><span className={styles.SiyamRupaliFont + " text-center"}>প্রতিষ্ঠানের স্বীকৃতি/স্বীকৃতি নবায়নের বাতিলকৃত আবেদনসমূহ</span></h4>
                                </div>
                            </Card.Header>
                            <Card.Body className="px-0">
...
export default InstRecognitionReject;