                                                ...
                                                filteredData.map((item, idx) => (
                                                    <tr key={idx}>
                                                        ...
                                                        <td className='text-center align-top text-wrap'>
                                                            ...
                                                            {item.email_ref && <Button type="button" variant="btn btn-outline-secondary" onClick={() => window.open(`${FRONTEND_URL}/order-emails?id_email=${item.email_ref}&prev_location=/recognition/rejected-list`, '_blank', 'noopener,noreferrer')}>তদন্তের আদেশ প্রিন্ট</Button>}
                                                        </td>
                                                        <td className='text-center align-top text-wrap'>
