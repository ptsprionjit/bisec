...
const InstClassStartPayment = () => {
    ...
    const handleSetNavigateClassStartApp = () => {
        setUserData({ ...buildPrintData, ...DEFAULT_CLS_DATA });
    ...
    const handleFetchSubmit = async (event) => {
        ...
        if (!form.checkValidity()) {
            ...
            if (!isValid) {
                ...
                try {
                    const user_data = await axios.post(`${BACKEND_URL}/institute/class_start/application_details`, { userData: userData });
    ...
    const handleBuildUpdateSubmit = async (event) => {
        ...
        if (!form.checkValidity()) {
            ...
            if (!isValid) {
                ...
                try {
                    const user_data = await axios.post(`${BACKEND_URL}/institute/class_start/build_update?`, formData, {
                ...
                <Col md={10}>
                    <Card className="card-transparent shadow-none d-flex justify-content-center m-0 p-0 auth-card">
                        <Card.Header className='d-flex flex-column p-0 m-0 py-3 justify-content-center align-items-center'>
                            <Link to="/institute/class-start/payment" onClick={handleFetchReset} className="navbar-brand d-flex justify-content-center align-items-start w-100 gap-3 m-0 p-0">
                                <Logo color={true} />
                                <h2 className="logo-title text-primary text-wrap text-center">{appName}</h2>
                            </Link>
                            <h4 className={styles.SiyamRupaliFont + " text-center text-uppercase text-secondary card-title pt-2"}>প্রতিষ্ঠানের পাঠদান শুরুর আবেদন</h4>
                        ...
                        <Card.Body className="m-0 p-0">
                            <Row className='d-flex justify-content-center align-items-center m-0 py-0'>
                                {classStartData.length > 0 && <Col md={10} className='d-flex justify-content-center align-items-center gap-5 py-3'>
                                    <Button onClick={() => setApplicationType(0)} className='flex-fill' type="button" variant="btn  btn-info"> প্রতিষ্ঠানের প্রাথমিক তথ্য </Button>
                                                ...
                                                <table id="user-list-table" className="table table-bordered">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td className='text-center align-top text-wrap p-2 m-0'>
                                                                <Button type="button" className='flex-fill w-50' variant="btn btn-outline-secondary" onClick={() => handleSetNavigateClassStartApp()}>আবেদন করুন</Button>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                    ...
                                                    <table key={idx} id="user-list-table" className="table table-bordered">
                                                        <tbody>
                                                            ...
                                                            {Number(classData.app_status) === 17 && classData.id_signed && <tr>
                                                                ...
                                                                <td className='text-center align-top text-wrap p-2 m-0'>
                                                                    <Button type="button" className='flex-fill w-50' variant="btn btn-outline-success" onClick={() => window.open(`${FRONTEND_URL}/institute/class-start/order?id_order=${classData.id_invoice}`, '_blank', 'noopener,noreferrer')}>অনুমতিপত্র প্রিন্ট</Button>
                                                                </td>
                                                            </tr>}
                ...
                <Col md={10}>
                    <Card className="card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                        <Card.Header className='d-flex flex-column mb-2 justify-content-center align-items-center'>
                            {!ceb_session && <Link to="/institute/class-start/payment" className="navbar-brand d-flex justify-content-center align-items-start w-100 gap-3">
                                <Logo color={true} />
                                <h2 className="logo-title text-primary text-wrap text-center">{appName}</h2>
                            </Link>}
...
export default InstClassStartPayment;