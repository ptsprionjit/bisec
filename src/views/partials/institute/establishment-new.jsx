...
const InstEstablishmentNew = () => {
    ...
    const curUrl = '/institute/establishment/application';
    ...
    const handleSubmit = async (event) => {
        ...
        if (!form.checkValidity()) {
            ...
            if (!isValid) {
                ...
                try {
                    const user_data = await axiosApi.post(`/institute/establishment/new_application`, formData, {
    ...
    const fetchDistrictPromise = useMemo(() => {
        return axiosApi.get(`/district-list`);
    }, []);
