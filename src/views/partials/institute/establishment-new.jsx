    ...
    const handleSubmit = async (event) => {
        ...
        if (!form.checkValidity()) {
            ...
            if (!isValid) {
                ...
                try {
                    const user_data = await axios.post(`${BACKEND_URL}/institute/establishment/new_application`, formData, {
        ...
        <Fragment>
            <Row className='d-flex flex-column justify-content-center align-items-center m-0 p-0'>
                <Col md={10}>
                    <Card className="card-transparent shadow-none d-flex justify-content-center mb-0 auth-card">
                        <Card.Header className='d-flex flex-column mb-2 justify-content-center align-items-center'>
                            {!ceb_session && <Link to="/institute-establishment/application" className="navbar-brand d-flex justify-content-center align-items-start w-100 gap-3">
                                <Logo color={true} />
                                <h2 className="logo-title text-primary text-wrap text-center">{appName}</h2>
                            </Link>}
                            ...
                            {prevApplication && <h6 className="text-uppercase text-center pt-4 text-success">{prevApplication}<Link to="/institute/establishment/payment"> লগইন</Link></h6>}
                        </Card.Header>
                        <hr />
                        <Card.Body className='d-flex flex-column justify-content-center align-items-center'>
                            <Col md={12}>
                                <Form noValidate onSubmit={handleSubmit} onReset={handleReset}>
                                    ...
                                    <Card className="m-0 p-0 mb-3">
                                        ...
                                        {prevApplication && <i className="text-uppercase text-center pt-4 text-success">{prevApplication}<Link to="/institute/establishment/payment"> লগইন</Link></i>}
...
export default InstEstablishmentNew;