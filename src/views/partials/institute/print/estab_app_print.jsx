                            ...
                            <table id="user-list-table" className="table table-bordered border-white">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{InputValidation.E2BDigit(buildPrintData.applicant_mobile)}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                    ...
                                    <tr>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{InputValidation.E2BDigit(buildPrintData.inst_land)}</span>
                                        </td>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{InputValidation.E2BDigit(buildPrintData.inst_ltax_num)} ({InputValidation.E2BDigit(buildPrintData.inst_ltax_year)})</span>
                                        </td>
                                    </tr>
                    ...
                    <Card className="card-transparent shadow-none d-flex justify-content-center auth-card m-0 py-5">
                        <Card.Body className='d-flex flex-column justify-content-center align-items-center m-0 p-0'>
                            <Col md={12} className='d-flex justify-content-around align-items-center gap-3'>
                                ...
                                <Button onClick={() => handlePrint(printRef, 'legal', "প্রতিষ্ঠান স্থাপনের আবেদন প্রিন্ট")} className='flex-fill' type="button" variant="btn btn-primary">প্রিন্ট করুন</Button>
