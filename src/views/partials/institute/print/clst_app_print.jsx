...
const ClassStartAppPrint = ({ navigateClassStartPrint, handleResetNavigateClassStartPrint, buildPrintData, classStartPrintData, estbFiles, classFiles, handleSetNavigateClassStartUpdate }) => {
                                ...
                                <thead>
                                    ...
                                    <tr className='bg-transparent'>
                                        <th colSpan={6} className='text-center align-top text-wrap m-0 p-0 py-2'>
                                            <p className={styles.SiyamRupaliFont + " fs-5 text-center text-uppercase text-secondary text-decoration-underline"}>নতুন প্রতিষ্ঠানের পাঠদানের আবেদনপত্র</p>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td colSpan={4} className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-primary"}>{classStartPrintData.bn_status || classStartPrintData.clst_status}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + ` text-center ${classStartPrintData.id_payment === '03' ? 'text-success' : 'text-danger'}`}>{classStartPrintData.bn_payment}</span>
                                        </td>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + ` text-center ${classStartPrintData.app_status === '17' ? 'text-success' : 'text-secondary'}`}>{classStartPrintData.bn_app_status}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colSpan={4} className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark text-uppercase"}>{buildPrintData.inst_en_name}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                    ...
                                    {buildPrintData.institute_named === '01' && <>
                                        ...
                                        <tr>
                                            ...
                                            <td className='text-left align-top text-wrap p-2 m-0'>
                                                <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{InputValidation.E2BDigit(buildPrintData.inst_founder_mobile)}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th className='text-left align-top text-wrap p-2 m-0'>
                                            ...
                                            <td className='text-left align-top text-wrap p-2 m-0'>
                                                <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{InputValidation.E2BDigit(buildPrintData.inst_founder_nid)}</span>
                                            </td>
                                            <th className='text-left align-top text-wrap p-2 m-0'>
                                            ...
                                            <td className='text-left align-top text-wrap p-2 m-0'>
                                                <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{InputValidation.E2BDigit(buildPrintData.inst_founder_dob)}</span>
                                            </td>
                                        </tr>
                                    </>}
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{InputValidation.E2BDigit(buildPrintData.inst_mobile)}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                    ...
                                    <tr>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{buildPrintData.bn_status || buildPrintData.build_status}</span>
                                        </td>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                    ...
                                    <tr>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{InputValidation.E2BDigit(buildPrintData.inst_distance)} কিঃমিঃ</span>
                                        </td>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{InputValidation.E2BDigit(buildPrintData.inst_population)} জন</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                    ...
                                    <tr>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{buildPrintData.inst_mouza_name}-{InputValidation.E2BDigit(buildPrintData.inst_mouza_number)}</span>
                                        </td>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{buildPrintData.en_khatiyan}-{InputValidation.E2BDigit(buildPrintData.inst_khatiyan_number)}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>মৌজার নাম ও নম্বর (নামজারি)</span>
                                        </th>
                                        <td className='text-center align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>:</span>
                                        </td>
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{InputValidation.E2BDigit(classStartPrintData.khatiyan_mouja)}</span>
                                        </td>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>খতিয়ান নম্বর (নামজারি)</span>
                                        </th>
                                        <td className='text-center align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>:</span>
                                        </td>
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{InputValidation.E2BDigit(classStartPrintData.khatiyan_mutation)}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{InputValidation.E2BDigit(classStartPrintData.khatiyan_total)} শতাংশ</span>
                                        </td>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{InputValidation.E2BDigit(classStartPrintData.tax_receipt)}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th colSpan={6} className='text-center align-top text-wrap p-0 py-2'>
                                    ...
                                    <tr>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{InputValidation.E2BDigit(classStartPrintData.class_room)} টি</span>
                                        </td>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{InputValidation.E2BDigit(classStartPrintData.office_room)} টি</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{InputValidation.E2BDigit(classStartPrintData.toilet_room)} টি</span>
                                        </td>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{InputValidation.E2BDigit(classStartPrintData.common_room)} টি</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{InputValidation.E2BDigit(classStartPrintData.library_room)} টি</span>
                                        </td>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{InputValidation.E2BDigit(classStartPrintData.computer_room)} টি</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{InputValidation.E2BDigit(classStartPrintData.total_books)} টি</span>
                                        </td>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{InputValidation.E2BDigit(classStartPrintData.total_computer)} টি</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{InputValidation.E2BDigit(classStartPrintData.labratory_room)} টি</span>
                                        </td>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{InputValidation.E2BDigit(classStartPrintData.founder_amount)} টাকা</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{InputValidation.E2BDigit(classStartPrintData.general_fund)} টাকা</span>
                                        </td>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{InputValidation.E2BDigit(classStartPrintData.reserved_fund)} টাকা</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th colSpan={6} className='text-center align-top text-wrap p-0 py-2'>
                                    ...
                                    {buildPrintData.institute_named === '01' && <tr className='print-hide'>
                                        ...
                                        <td colSpan={1} className='text-left align-top text-wrap p-2 m-0'>
                                            {classFiles.named_fund_details && String(classFiles.named_fund_details.name).toLocaleLowerCase() === 'named_fund_details.pdf' && <Button onClick={() => HandleFileView(classFiles.named_fund_details)} type='button' variant='btn btn-link' className='w-100 m-0 p-0'><span className={styles.SiyamRupaliFont + " text-center text-primary"}>ব্যক্তি কর্তৃক জমাকৃত তহবিল</span></Button>}
                                        </td>
                                    </tr>}
                                    <tr className='print-hide'>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            {estbFiles.applicant_details && String(estbFiles.applicant_details.name).toLocaleLowerCase() === 'applicant_details.pdf' && <Button onClick={() => HandleFileView(estbFiles.applicant_details)} type='button' variant='btn btn-link' className='w-100 m-0 p-0'><span className={styles.SiyamRupaliFont + " text-center text-primary"}>আবেদনকারীগণের সংক্ষিপ্ত বিবরণ</span></Button>}
                                        </td>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                    ...
                                    <tr className='print-hide'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            {estbFiles.land_details && String(estbFiles.land_details.name).toLocaleLowerCase() === 'land_details.pdf' && <Button onClick={() => HandleFileView(estbFiles.land_details)} type='button' variant='btn btn-link' className='w-100 m-0 p-0'><span className={styles.SiyamRupaliFont + " text-center text-primary"}>জমির দলিল</span></Button>}
                                        </td>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            {estbFiles.ltax_details && String(estbFiles.ltax_details.name).toLocaleLowerCase() === 'ltax_details.pdf' && <Button onClick={() => HandleFileView(estbFiles.ltax_details)} type='button' variant='btn btn-link' className='w-100 m-0 p-0'><span className={styles.SiyamRupaliFont + " text-center text-primary"}>খাজনার দাখিলা</span></Button>}
                                        </td>
                                    </tr>
                                    <tr className='print-hide'>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                    ...
                                    <tr className='print-hide'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            {estbFiles.declare_form && String(estbFiles.declare_form.name).toLocaleLowerCase() === 'declare_form.pdf' && <Button onClick={() => HandleFileView(estbFiles.declare_form)} type='button' variant='btn btn-link' className='w-100 m-0 p-0'><span className={styles.SiyamRupaliFont + " text-center text-primary"}>অঙ্গীকারনামা</span></Button>}
                                        </td>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            {estbFiles.feasibility_details && String(estbFiles.feasibility_details.name).toLocaleLowerCase() === 'feasibility_details.pdf' && <Button onClick={() => HandleFileView(estbFiles.feasibility_details)} type='button' variant='btn btn-link' className='w-100 m-0 p-0'><span className={styles.SiyamRupaliFont + " text-center text-primary"}>স্থাপনের যৌক্তিকতা</span></Button>}
                                        </td>
                                    </tr>
                                    <tr className='print-hide'>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            {classFiles.mutation_details && String(classFiles.mutation_details.name).toLocaleLowerCase() === 'mutation_details.pdf' && <Button onClick={() => HandleFileView(classFiles.mutation_details)} type='button' variant='btn btn-link' className='w-100 m-0 p-0'><span className={styles.SiyamRupaliFont + " text-center text-primary"}>নামজারি খতিয়ান</span></Button>}
                                        </td>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>হাল দাখিলা</span>
                                        </th>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            {classFiles.dakhila_details && String(classFiles.dakhila_details.name).toLocaleLowerCase() === 'dakhila_details.pdf' && <Button onClick={() => HandleFileView(classFiles.dakhila_details)} type='button' variant='btn btn-link' className='w-100 m-0 p-0'><span className={styles.SiyamRupaliFont + " text-center text-primary"}>হাল দাখিলা</span></Button>}
                                        </td>
                                    </tr>
                                    <tr className='print-hide'>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            {classFiles.general_fund_details && String(classFiles.general_fund_details.name).toLocaleLowerCase() === 'general_fund_details.pdf' && <Button onClick={() => HandleFileView(classFiles.general_fund_details)} type='button' variant='btn btn-link' className='w-100 m-0 p-0'><span className={styles.SiyamRupaliFont + " text-center text-primary"}>সাধারণ তহবিলের প্রমাণক</span></Button>}
                                        </td>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            {classFiles.reserved_fund_details && String(classFiles.reserved_fund_details.name).toLocaleLowerCase() === 'reserved_fund_details.pdf' && <Button onClick={() => HandleFileView(classFiles.reserved_fund_details)} type='button' variant='btn btn-link' className='w-100 m-0 p-0'><span className={styles.SiyamRupaliFont + " text-center text-primary"}>সংরক্ষিত তহবিলের প্রমাণক</span></Button>}
                                        </td>
                                    </tr>
                                    {/* <tr className='print-hide'>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td colSpan={4} className='text-left align-top text-wrap p-2 m-0'>
                                            {classFiles.order_build_js && String(classFiles.order_build_js.name).toLocaleLowerCase() === 'order_build_js.pdf' && <Button onClick={() => HandleFileView(classFiles.order_build_js)} type='button' variant='btn btn-link' className='w-100 m-0 p-0'><span className={styles.SiyamRupaliFont + " text-center text-primary"}>নিম্ন মাধ্যমিক স্থাপন</span></Button>}
                                            {classFiles.order_build_ss && String(classFiles.order_build_ss.name).toLocaleLowerCase() === 'order_build_ss.pdf' && <Button onClick={() => HandleFileView(classFiles.order_build_ss)} type='button' variant='btn btn-link' className='w-100 m-0 p-0'><span className={styles.SiyamRupaliFont + " text-center text-primary"}>মাধ্যমিক স্থাপন</span></Button>}
                                            {classFiles.order_build_hs && String(classFiles.order_build_hs.name).toLocaleLowerCase() === 'order_build_hs.pdf' && <Button onClick={() => HandleFileView(classFiles.order_build_hs)} type='button' variant='btn btn-link' className='w-100 m-0 p-0'><span className={styles.SiyamRupaliFont + " text-center text-primary"}>উচ্চ মাধ্যমিক স্থাপন</span></Button>}
                                        </td>
                                    </tr>
                                    <tr className='print-hide'>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td colSpan={4} className='text-left align-top text-wrap p-2 m-0'>
                                            {classFiles.order_class_js && String(classFiles.order_class_js.name).toLocaleLowerCase() === 'order_class_js.pdf' && <Button onClick={() => HandleFileView(classFiles.order_class_js)} type='button' variant='btn btn-link' className='w-100 m-0 p-0'><span className={styles.SiyamRupaliFont + " text-center text-primary"}>নিম্ন মাধ্যমিক পাঠদান</span></Button>}
                                            {classFiles.order_class_ss && String(classFiles.order_class_ss.name).toLocaleLowerCase() === 'order_class_ss.pdf' && <Button onClick={() => HandleFileView(classFiles.order_class_ss)} type='button' variant='btn btn-link' className='w-100 m-0 p-0'><span className={styles.SiyamRupaliFont + " text-center text-primary"}>মাধ্যমিক পাঠদান</span></Button>}
                                            {classFiles.order_class_hs && String(classFiles.order_class_hs.name).toLocaleLowerCase() === 'order_class_hs.pdf' && <Button onClick={() => HandleFileView(classFiles.order_class_hs)} type='button' variant='btn btn-link' className='w-100 m-0 p-0'><span className={styles.SiyamRupaliFont + " text-center text-primary"}>উচ্চ মাধ্যমিক পাঠদান</span></Button>}
                                        </td>
                                    </tr>
                                    <tr className='print-hide'>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td colSpan={4} className='text-left align-top text-wrap p-2 m-0'>
                                            {classFiles.order_recognition_js && String(classFiles.order_recognition_js.name).toLocaleLowerCase() === 'order_recognition_js.pdf' && <Button onClick={() => HandleFileView(classFiles.order_recognition_js)} type='button' variant='btn btn-link' className='w-100 m-0 p-0'><span className={styles.SiyamRupaliFont + " text-center text-primary"}>নিম্ন মাধ্যমিক স্বীকৃতি</span></Button>}
                                            {classFiles.order_recognition_ss && String(classFiles.order_recognition_ss.name).toLocaleLowerCase() === 'order_recognition_ss.pdf' && <Button onClick={() => HandleFileView(classFiles.order_recognition_ss)} type='button' variant='btn btn-link' className='w-100 m-0 p-0'><span className={styles.SiyamRupaliFont + " text-center text-primary"}>মাধ্যমিক স্বীকৃতি</span></Button>}
                                            {classFiles.order_recognition_hs && String(classFiles.order_recognition_hs.name).toLocaleLowerCase() === 'order_recognition_hs.pdf' && <Button onClick={() => HandleFileView(classFiles.order_recognition_hs)} type='button' variant='btn btn-link' className='w-100 m-0 p-0'><span className={styles.SiyamRupaliFont + " text-center text-primary"}>উচ্চ মাধ্যমিক স্বীকৃতি</span></Button>}
                                        </td>
                                    </tr> */}
                                </tbody>
                                <tfoot>
                    ...
                    <Card className="card-transparent shadow-none d-flex justify-content-center m-0 py-5 auth-card">
                        <Card.Body className='d-flex flex-column justify-content-center align-items-center m-0 p-0'>
                            <Col md={12} className='d-flex justify-content-around align-items-center gap-5'>
                                ...
                                <Button onClick={() => handlePrint(printRef, 'legal', "প্রতিষ্ঠানের পাঠদান আবেদন প্রিন্ট")} className='flex-fill' type="button" variant="btn btn-primary">প্রিন্ট করুন</Button>
                                {handleSetNavigateClassStartUpdate && (classStartPrintData.id_payment !== '03' || classStartPrintData.proc_status === '12') && <Button onClick={() => handleSetNavigateClassStartUpdate()} className='flex-fill' type="button" variant="btn btn-success">আপডেট করুন</Button>}
                            </Col>
                        </Card.Body>
                    </Card>
                </Col>
