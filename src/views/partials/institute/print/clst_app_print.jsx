...
const ClassStartAppPrint = ({
    navigateClassStartPrint, handleResetNavigateClassStartPrint, buildPrintData, classStartPrintData, estbFiles, classFiles, handleSetNavigateClassStartUpdate
}) => {
                            ...
                            <table id="user-list-table" className="table table-bordered w-100 m-0 p-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{ValidationInput.E2BDigit(classStartPrintData.khatiyan_mouja)}</span>
                                        </td>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{ValidationInput.E2BDigit(classStartPrintData.khatiyan_mutation)}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{ValidationInput.E2BDigit(classStartPrintData.khatiyan_total)} শতাংশ</span>
                                        </td>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{ValidationInput.E2BDigit(classStartPrintData.tax_receipt)}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th colSpan={6} className='text-center align-top text-wrap p-0 py-2'>
                                    ...
                                    <tr>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{ValidationInput.E2BDigit(classStartPrintData.class_room)} টি</span>
                                        </td>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{ValidationInput.E2BDigit(classStartPrintData.office_room)} টি</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{ValidationInput.E2BDigit(classStartPrintData.toilet_room)} টি</span>
                                        </td>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{ValidationInput.E2BDigit(classStartPrintData.common_room)} টি</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{ValidationInput.E2BDigit(classStartPrintData.library_room)} টি</span>
                                        </td>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{ValidationInput.E2BDigit(classStartPrintData.computer_room)} টি</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{ValidationInput.E2BDigit(classStartPrintData.total_books)} টি</span>
                                        </td>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{ValidationInput.E2BDigit(classStartPrintData.total_computer)} টি</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{ValidationInput.E2BDigit(classStartPrintData.labratory_room)} টি</span>
                                        </td>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{ValidationInput.E2BDigit(classStartPrintData.founder_amount)} টাকা</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{ValidationInput.E2BDigit(classStartPrintData.general_fund)} টাকা</span>
                                        </td>
                                        <th className='text-left align-top text-wrap p-2 m-0'>
                                        ...
                                        <td className='text-left align-top text-wrap p-2 m-0'>
                                            <span className={styles.SiyamRupaliFont + " text-center text-dark"}>{ValidationInput.E2BDigit(classStartPrintData.reserved_fund)} টাকা</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th colSpan={6} className='text-center align-top text-wrap p-0 py-2'>
