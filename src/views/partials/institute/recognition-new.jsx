...
import { recognitionAppEvalReg, recognitionAppEvalExm } from './evaluation/recog_eval';
                                                ...
                                                <table id="user-list-table" className="table table-bordered">
                                                    <tbody>
                                                        ...
                                                        {(fetchStatus?.success && userData.id_signed && userData.app_status === '17') && <tr>
                                                            ...
                                                            <td className='text-center align-top text-wrap p-2 m-0'>
                                                                <Button type="button" className='flex-fill w-50' variant="btn btn-outline-success" onClick={() => window.open(`${FRONTEND_URL}/institute/recognition/order?id_order=${userData.id_invoice}&prev_location=/recognition/new`, '_blank', 'noopener,noreferrer')}>প্রিন্ট করুন</Button>
                                                            </td>
                                                        </tr>}
                                                    </tbody>
                                                </table>
