                                 ...
                                 filteredData.map((item, idx) => (
                                    <tr key={idx}>
                                       ...
                                       <td className='text-center align-top text-wrap'>
                                          ...
                                          <Button type="button" variant="btn btn-outline-primary" onClick={() => window.open(`${FRONTEND_URL}/payment/response/success?prev_location=/establishment/authorized-list&invoiceNo=${item.id_invoice}`, '_blank', 'noopener,noreferrer')}>প্রিন্ট ভাউচার</Button>
                                       </td>
                                       <td className='text-center align-top text-wrap'>
                                       ...
                                       <td className='text-center align-top text-wrap'>
                                          ...
                                          <Button type="button" className='w-100' variant="btn btn-success" onClick={() => window.open(`${FRONTEND_URL}/institute/establishment/order?id_order=${item.id_invoice}&prev_location=/establishment/authorized-list`, '_blank', 'noopener,noreferrer')}>অনুমতিপত্র</Button>
                                       </td>
                                       <td>
