...
const InstRecognitionFinal = () => {
    ...
    const fetchDataList = async () => {
        ...
        try {
            const response = await axiosApi.post(`/institute/recognition/final_list`);
                                            ...
                                            filteredData.map((item, idx) => (
                                                <tr key={idx}>
                                                    ...
                                                    <td className='text-center align-top text-wrap'>
                                                        ...
                                                        {item.email_ref && <Button type="button" variant="btn btn-outline-secondary" onClick={() => window.open(`${FRONTEND_URL}/order-emails?id_email=${item.email_ref}&prev_location=/recognition/authorized-list`, '_blank', 'noopener,noreferrer')}>তদন্তের আদেশ প্রিন্ট</Button>}
                                                    </td>
                                                    <td className='text-center align-top text-wrap'>
                                                        ...
                                                        <Button type="button" variant="btn btn-outline-primary" onClick={() => window.open(`${FRONTEND_URL}/payment/response/success?prev_location=/recognition/authorized-list&invoiceNo=${item.id_invoice}`, '_blank', 'noopener,noreferrer')}>প্রিন্ট ভাউচার</Button>
                                                    </td>
                                                    {/* <td className='text-center align-top text-wrap'>
                                                    ...
                                                    <td className='text-center align-top text-wrap'>
                                                        ...
                                                        <Button type="button" className='w-100' variant="btn btn-success" onClick={() => window.open(`${FRONTEND_URL}/institute/class-start/order?id_order=${item.id_invoice}prev_location=/recognition/authorized-list`, '_blank', 'noopener,noreferrer')}>অনুমতিপত্র</Button>
                                                    </td>
                                                    <td>
