                                                ...
                                                filteredData.map((item, idx) => (
                                                    <tr key={idx}>
                                                        ...
                                                        <td className='text-center align-top text-wrap'>
                                                            ...
                                                            <Button type="button" variant="btn btn-outline-primary" onClick={() => window.open(`${FRONTEND_URL}/payment/response/success?prev_location=/recognition/pending-list&invoiceNo=${item.id_invoice}`, '_blank', 'noopener,noreferrer')}>ভাউচার</Button>
                                                        </td>
                                                        {/* <td className='text-center align-top text-wrap'>
