...
const InstituteUpdateAuthorized = () => {
    ...
    const fetchDataList = async () => {
        ...
        try {
            const response = await axiosApi.post(`/institute/update/list`, { userData: { id_status: '17' } });
            if (response.status === 200) {
                    ...
                    <Card>
                        <Card.Header className="d-flex justify-content-between">
                            <div className="header-title d-flex flex-column justify-content-center align-items-center w-100">
                                <h4 className={" card-title text-center text-primary flex-fill"}>প্রতিষ্ঠানের প্রতিষ্ঠানের নতুন শিফট/শাখা/বিভাগ/বিষয় খোলার অনুমোদিত আবেদনসমূহ</h4>
...
export default InstituteUpdateAuthorized;