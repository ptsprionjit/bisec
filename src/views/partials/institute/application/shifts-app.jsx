...
const InstShiftsApp = ({ userData, setUserData, groupList, subjectList, listGroupSubject, listShift, status, setStatus, setShow }) => {
    ...
    const handleSubmit = async (event) => {
        ...
        if (!userData[fieldGroupSub.shifts].length && !userData[fieldGroupSub.section].length && !userData[fieldGroupSub.group].length && !userData[fieldGroupSub.subject].length) {
            setStatus({ loading: false, success: false, error: "কমপক্ষে একটি শিফট সিলেক্ট করতে হবে!" });
            isValidData = false;
        }
