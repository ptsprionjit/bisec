...
const InstituteUpdateRejected = () => {
    ...
    const fetchDataList = async () => {
        ...
        try {
            const response = await axiosApi.post(`/institute/update/list`, { userData: { id_status: '18' } });
            if (response.status === 200) {
                    ...
                    <Card>
                        <Card.Header className="d-flex justify-content-between">
                            <div className="header-title d-flex flex-column justify-content-center align-items-center w-100">
                                <h4 className={" card-title text-center text-primary flex-fill"}>প্রতিষ্ঠানের প্রতিষ্ঠানের নতুন শিফট/শাখা/বিভাগ/বিষয় খোলার বাতিলকৃত আবেদনসমূহ</h4>
                                                ...
                                                filteredData.map((item, idx) => (
                                                    <tr key={idx}>
                                                        ...
                                                        <td className='text-center align-top text-wrap'>
                                                            ...
                                                            <Button type="button" className='w-100 text-nowrap p-2 m-0' variant="btn btn-outline-info" onClick={() => handleMessageClick(item)}>মন্তব্য</Button>                                                        </td>
                                                        <td className='text-center text-wrap'>
                                                            <div className="d-flex justify-content-evenly align-items-center flex-wrap gap-3">
                                                                ...
                                                                {Number(permissionData.role) >= 16 && <Button className='m-0 p-1' type="button" onClick={() => handleSendBackClick(item)} variant="btn btn-warning" data-toggle="tooltip" data-placement="top" title="ফের‌ৎ পাঠানো" data-original-title="ফেরৎ পাঠানো">
                                                                    <span className="btn-inner">
...
export default InstituteUpdateRejected;