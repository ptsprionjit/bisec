                                            ...
                                            filteredData.map((item, idx) => (
                                                <tr key={idx}>
                                                    ...
                                                    <td className='text-center align-top text-wrap'>
                                                        ...
                                                        {item?.id_signed && <Button type="button" className='w-100' variant="btn btn-success" onClick={() => window.open(`${FRONTEND_URL}/institute/recognition/order?id_order=${item.id_invoice}&prev_location=/institute/recognition/all-list`, '_blank', 'noopener,noreferrer')}>অনুমতিপত্র</Button>}
                                                    </td>
                                                    <td>
