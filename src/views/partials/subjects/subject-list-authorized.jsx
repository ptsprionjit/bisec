...
const SubjectAppAuthorized = () => {
    ...
    useEffect(() => {
        if (examList.length) {
            ...
            setUserData((prev) => ({ ...prev, id_status: '17' }));
        }
    }, [examList]);
    ...
    if (status.loading && !activeAppReject && !activeAppUpdate) return (
        <Fragment>
...
export default SubjectAppAuthorized;