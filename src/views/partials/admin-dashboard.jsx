...
const AdminDashBoard = memo((props) => {
  ...
  const setChart = () => {
    ...
    if (chartData1 === "01") {
      ...
      dataTitle1 = ["ষষ্ট (০৬)", "সপ্তম (০৭)", "অষ্টম (০৮)", "নবম (০৯)", "দশম (১০)", "একাদশ (১১)", "দ্বাদশ (১২)"];
    } else {
      const id_examQQ03 = exmData.id_examQQ03 || 0;
      const id_examQQ04 = exmData.id_examQQ04 || 0;
      const id_examQQ05 = exmData.id_examQQ05 || 0;
      const id_examQQ07 = exmData.id_examQQ07 || 0;
      dataValue1 = [id_examQQ03, id_examQQ04, id_examQQ05, id_examQQ07];
      dataTitle1 = ["JSC", "JSE", "SSC", "HSC"];
    }
    ...
    var dataValueReg = [st_classQQ06, st_classQQ07, st_classQQ08, st_classQQ09, st_classQQ10, st_classQQ11, st_classQQ12,
    ];
    var dataValueExm = [st_classQQ06, st_classQQ07, id_examQQ03 || id_examQQ04, st_classQQ09, id_examQQ05, st_classQQ11, id_examQQ07];
    var dataTitleReg = ["ষষ্ট (০৬)", "সপ্তম (০৭)", "অষ্টম (০৮)", "নবম (০৯)", "দশম (১০)", "একাদশ (১১)", "দ্বাদশ (১২)"];
    //chart3
    const myChart3 = {
      // options: {
      //   chart: {
  ...
  const aggregateCounts = ({ dataSource, totalKey, extraTotals = [] }) => {
    ...
    Object.entries(dataSource).forEach(([fieldKey, rowData]) => {
      ...
      if (rowData.pay_total !== null && result.payment_total !== null) {
        result.payment_total += rowData.pay_total;
      }
    });
  ...
  }, [permissionData]); // eslint-disable-next-line react-hooks/exhaustive-deps
            ...
            <Modal.Body className="bg-transparent">
              <Card className="bg-transparent">
                <Card.Header className="bg-transparent">
                  <h5 className="text-center">অপেক্ষা করুন... তথ্য সংগ্রহ করা হচ্ছে...</h5>
                </Card.Header>
                  ...
                  <div className="card-body">
                    <div className="progress-widget">
                      <Circularprogressbar
                        ...
                        style={{ width: 60, height: 60 }}
                        value={
                          // ((exmData.id_examQQ03 + exmData.id_examQQ05 + exmData.id_examQQ07) / exmData.active_total) * 100
                        ...
                        {noticeData.map((noticeItem, idx) => {
                          ...
                          return (
                            <tr key={idx}>
                              ...
                              <td className="text-center align-center text-wrap text_dark">
                                <h6>
                                  <h6>{InputValidation.E2BDigit(InputValidation.formatedDate(noticeItem.dt_start))} {" থেকে "} {InputValidation.E2BDigit(InputValidation.formatedDate(noticeItem.dt_end))}</h6>
                                </h6>
                              </td>
                              <td className="text-center align-center text-wrap text_dark">
                    ...
                    >
                      ...
                      <div className="ms-4 flex-fill">
                        ...
                        <small className="mb-0 d-block">
                          সময়ঃ {InputValidation.E2BDigit(InputValidation.formatedDate(data.dt_start))} থেকে{" "}
                          {InputValidation.E2BDigit(InputValidation.formatedDate(data.dt_end))}
                        </small>
                        <small className="mb-0 d-block">
