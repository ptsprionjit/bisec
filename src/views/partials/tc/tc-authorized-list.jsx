...
const TcAuthorizedList = () => {
   ...
   const fetchTcList = async () => {
      ...
      const [st_class, st_year, list_type] = [
         stClass,
         stSession,
         "17",
      ];
   ...
   function handleOrderPrint(item) {
                  ...
                  <Card>
                     <Card.Header className="d-flex justify-content-between">
                        <div className="header-title d-flex flex-column justify-content-center align-items-center w-100">
                           <h4 className="card-title text-center text-primary flex-fill"><span className={styles.SiyamRupaliFont + " text-center"}>অনুমোদিত ট্রান্সফার সার্টিফিকেট (TC) আবেদনসমূহ</span></h4>
                                          ...
                                          <tr key={idx}>
                                             ...
                                             <td>
                                                <div className="d-flex justify-content-center align-items-center gap-3 list-user-action">
                                                   ...
                                                   {item.src_board_auth === '17' && item.dst_board_auth === '17' && <Button className='m-0 p-1' type="button" onClick={() => handleOrderPrint(item)} variant="btn btn-success" data-toggle="tooltip" data-placement="top" title="টিসি আদেশ" data-original-title="টিসি আদেশ">
                                                      <span className="btn-inner">
                                                         <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-printer-check-icon lucide-printer-check"><path d="M13.5 17H7a1 1 0 0 1-1-1v-6a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v.5" /><path d="m16 19 2 2 4-4" /><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v2" /><path d="M6 9V3a1 1 0 0 1 1-1h10a1 1 0 0 1 1 1v6" /></svg>
                                                      </span>
                                                   </Button>}
                                                </div>
                                             </td>
                           ...
                           {/* {activeAppAuthorize && (
                              ...
                              >
                                 ...
                                 <Modal.Footer>
                                    ...
                                    {isBoard && activeAppAuthorize.src_eiin_auth === '17' && activeAppAuthorize.dst_eiin_auth === '17' && <Button variant="success" onClick={() => tcAuthorize(activeAppAuthorize.id_invoice)}>
                                       সম্মত
                                    </Button>}
...
export default TcAuthorizedList;