...
import { Table, Row, Col, Form, Button, Modal, Image } from 'react-bootstrap'
   ...
   const fetchTcList = async () => {
      ...
      try {
         ...
         if (response.status === 200) {
            ...
            setValidated(false);
            setStError("কোন অপেক্ষমান আবেদন পাওয়া যায়নি!");
         }
      } catch (err) {
...
setValidated(false);
   ...
   async function tcAuthorize(id_invoice) {
      ...
      try {
         ...
         await axios.post(`${BACKEND_URL}/student/tc/application/authorize?`, { userData: myData });
               ...
               <Card>
                  <Card.Header className="d-flex justify-content-between">
                     <div className="header-title d-flex flex-column justify-content-center align-items-center w-100">
                        <h4 className="card-title text-center text-primary flex-fill"><span className={styles.SiyamRupaliFont + " text-center"}>অপেক্ষমান ট্রান্সফার সার্টিফিকেট (TC) আবেদনসমূহ</span></h4>
         ...
         {activeAppAuthorize && (
            ...
            >
               ...
               <Modal.Footer>
                  ...
                  {isBoard && ((activeAppAuthorize.dst_board === '11' && activeAppAuthorize.src_eiin_auth === '17' && activeAppAuthorize.dst_eiin_auth === '17') || (activeAppAuthorize.dst_board !== '11' && activeAppAuthorize.src_eiin_auth === '17')) && <Button variant="success" onClick={() => tcAuthorize(activeAppAuthorize.id_invoice)}>
                     সম্মত
                  </Button>}
