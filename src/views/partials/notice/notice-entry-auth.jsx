...
const NoticeEntryFinal = () => {
   ...
   const [userData, setUserData] = useState({
      eco_code: '', new_code: '', online_code: '', user_session: '', user_class: '', user_group: '', user_version: '', user_application: '', en_notice: '', bn_notice: '', file_notice: '', dt_start: '', dt_end: '',
   });
         ...
         if (!isValid) {
            ...
            try {
               ...
               if (response.status === 200) {
                  ...
                  setUserData({ ...userData, ...response.data.noticeData });
   ...
   const handleUpdateReject = async (event) => {
      ...
      if (form.checkValidity() === false) {
         ...
         if (!isValid) {
            ...
            setLoadingData("তথ্য বাতিল করা হচ্ছে! অপেক্ষা করুন...");
            try {
               const myData = {
                  ...
                  <Card>
                     <Card.Body>
                        <Row>
                           ...
                           <Col md={12}>
                              <p className='my-4 text-center text-primary'>এন্ট্রিকৃত নোটিশের তথ্য</p>
                           </Col>
                           <Row>
                              <Col md={9}>
                                 <Row>
                                 ...
                                 <Card className="m-0 p-0">
                                    ...
                                    <Card.Footer className="d-flex justify-content-center">
                                       {!files.file_notice && !userDataError.file_notice &&
                                          <p className='my-2 pt-2 text-center text-danger'>
                                             <small>
                                                <i>
                                                   কোন নোটিশ আপ্লোড করা হয়নি!
                                                </i>
                                             </small>
                                          </p>
                                       }
...
export default NoticeEntryFinal;